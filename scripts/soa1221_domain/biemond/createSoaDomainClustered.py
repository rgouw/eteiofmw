...
WLHOME      = FMWHOME+'/wlserver'

DOMAIN      = 'soa_domain'
DOMAIN_PATH = '/u01/app/work/domains/soa_domain'
APP_PATH    = '/u01/app/work/domains/applications/soa_domain'
...
SOA_REPOS_DBURL          = 'jdbc:oracle:thin:@darlin-vce-db:1521/pdborcl'
SOA_REPOS_DBUSER_PREFIX  = 'DEV'
SOA_REPOS_DBPASSWORD     = 'DEV_STB'
...
wlsjar = '/u01/app/oracle/FMW12210/wlserver/common/templates/wls/wls.jar'
#print('Start...wls domain with template /opt/oracle/middleware12c/wlserver/common/templates/wls/wls.jar')
print('Start...wls domain with template '+wlsjar)
...
wlservicetpl='/u01/app/oracle/FMW12210/oracle_common/common/templates/wls/oracle.wls-webservice-template.jar'
...
print('Extend...osb domain with template '+wlservicetpl)
addTemplate(wlservicetpl)
osbtpl='/u01/app/oracle/FMW12210/osb/common/templates/wls/oracle.osb_template.jar'
print('Extend...osb domain with template '+osbtpl)
#addTemplate('/opt/oracle/middleware12c/osb/common/templates/wls/oracle.osb_template_12.1.3.jar')
addTemplate(osbtpl)

applCoreTpl='/u01/app/oracle/FMW12210/oracle_common/common/templates/wls/oracle.applcore.model.stub_template.jar'
...
soatpl='/u01/app/oracle/FMW12210/soa/common/templates/wls/oracle.soa_template.jar'
...
if BAM_ENABLED == true:
  bamtpl='/u01/app/oracle/FMW12210/soa/common/templates/wls/oracle.bam.server_template.jar'
...
if BPM_ENABLED == true:
  bpmtpl='/u01/app/oracle/FMW12210/soa/common/templates/wls/oracle.bpm_template.jar'
...
if ESS_ENABLED == true:
  essBasicTpl='/u01/app/oracle/FMW12210/oracle_common/common/templates/wls/oracle.ess.basic_template.jar'
  essEmTpl='/u01/app/oracle/FMW12210/em/common/templates/wls/oracle.em_ess_template.jar'
